...
import { AlignmentType, Document, Packer, Paragraph, TextRun, ISectionOptions, patchDocument, PatchType, Alignment, WidthType, convertMillimetersToTwip, ShadingType, Tab } from "docx";
...
import {generateTableFromPartidas, patchEncabezado, patchTable } from 'src/toolbox/forTablas/manejaTablas';
import { NumerosALetrasPeruano } from 'src/toolbox/numerosALetras/combierteNumeroLetra';
import { fixPathAssets } from 'src/toolbox/forDeploy/fixPath';
...
export class ValorizacionService {
    ...
    public async informeresidente(googleFileId:string){
        console.log(NumerosALetrasPeruano(1111234.25))
